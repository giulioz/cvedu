...
// import { Canvas, useLoader, useFrame, useThree, useUpdate } from '@react-three/fiber';
...
//   const [diffuse, bump, rough] = (useLoader as any)(THREE.TextureLoader, ['/game/road_diffuse.png', '/game/road_bump.png', '/game/road_rough.png']);
...
//   const model: any = useLoader(GLTFLoader, '/game/car.glb', (loader: GLTFLoader) => {
...
//   const [diffuse, normal] = (useLoader as any)(THREE.TextureLoader, ['/game/crate_diffuse.png', '/game/crate_normal.png']);
